/* Quelle: https://github.com/alexisrolland/star-wars-data/blob/master/database.sql  */
/* Anpassung für sqlite: Kein CREATE DATABASE
   Stattdessen leere Datei starwars.db anlegen
   und in PyCharm als data source angeben
   Driver Files für sqlite herunterladen
   KEIN CREATE SCHEMA (sqlite ist minimalistisch aufgebaut)
   Verweise base. entfernt (bezieht sich aufs Schema, das es nicht gibt)
   z. B. CREATE TABLE planet statt CREATE TABLE base.planet
 */
